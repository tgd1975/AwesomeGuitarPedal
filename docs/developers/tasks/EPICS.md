...
**Overall:** 🔵 **active** — ███░░░░░░░ 12/45 (27%) across 11 groups — 26 open · 0 active · 7 paused · 12 closed
...
| [EPIC-029](#epic-029-named-pins--portable-pin-vocabulary-for-shareable-profiles) | Named pins — portable pin vocabulary for shareable profiles | 🔵 **active** | 5 | 0 | 0 | 5 | █████░░░░░ 50% |
...
**Status:** 🔵 **active** — █████░░░░░ 5/10 (50%)

```mermaid
graph LR
    TASK_382["TASK-382"]:::open
    TASK_389["TASK-389"]:::open
    TASK_390["TASK-390"]:::open
    TASK_391["TASK-391"]:::open
    TASK_392["TASK-392"]:::open
    ...
    click TASK_389 "open/task-389-pin-names-catalog-service.md"
    click TASK_390 "open/task-390-action-editor-named-pin-ux.md"
    click TASK_391 "open/task-391-missing-mapping-warning-surfaces.md"
    click TASK_392 "open/task-392-js-config-builder-pinnames-ux.md"
...
| 7 | [TASK-389](open/task-389-pin-names-catalog-service.md) | PinNamesCatalog service — Flutter-side reader of pin-names.schema.json | ⚪ _open_ | Small (&lt;2h) |
| 8 | [TASK-390](open/task-390-action-editor-named-pin-ux.md) | Action editor (Flutter) — named-pin picker with autocomplete and inline mapping hint | ⚪ _open_ | Medium (2-8h) |
| 9 | [TASK-391](open/task-391-missing-mapping-warning-surfaces.md) | Missing-mapping warning surfaces — profile editor + connected-pedal page | ⚪ _open_ | Small (&lt;2h) |
| 10 | [TASK-392](open/task-392-js-config-builder-pinnames-ux.md) | JS config-builder — pinNames mapping editor with autocomplete and non-standard validation | ⚪ _open_ | Small (&lt;2h) |
