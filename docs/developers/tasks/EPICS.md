...
**Overall:** 🔵 **active** — █░░░░░░░░░ 4/40 (10%) across 11 groups — 28 open · 1 active · 7 paused · 4 closed
...
| [EPIC-028](#epic-028-configurable-button-debounce-in-the-hardware-config) | Configurable button debounce in the hardware config | 🔵 **active** | 1 | 1 | 0 | 0 | ░░░░░░░░░░ 0% |
...
graph LR
    ...
    TASK_375["TASK-375"]:::active
    TASK_375 --> TASK_376
    click TASK_376 "open/task-376-esp32-button-reads-debouncems-from-hardware-config.md"
    click TASK_375 "active/task-375-add-debouncems-to-hardware-config-schema-and-model.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| 1 | [TASK-375](active/task-375-add-debouncems-to-hardware-config-schema-and-model.md) | Add debounceMs to hardware-config schema, example JSON, and Dart model | 🔵 **active** | Small (&lt;2h) |
