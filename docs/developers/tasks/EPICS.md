...
**Overall:** 🔵 **active** — ███░░░░░░░ 14/45 (31%) across 11 groups — 23 open · 1 active · 7 paused · 14 closed
...
| [EPIC-029](#epic-029-named-pins--portable-pin-vocabulary-for-shareable-profiles) | Named pins — portable pin vocabulary for shareable profiles | 🔵 **active** | 2 | 1 | 0 | 7 | ███████░░░ 70% |
...
**Status:** 🔵 **active** — ███████░░░ 7/10 (70%)

```mermaid
graph LR
    TASK_382["TASK-382"]:::open
    TASK_392["TASK-392"]:::open
    TASK_391["TASK-391"]:::active
    ...
    click TASK_391 "active/task-391-missing-mapping-warning-surfaces.md"
...
| 9 | [TASK-391](active/task-391-missing-mapping-warning-surfaces.md) | Missing-mapping warning surfaces — profile editor + connected-pedal page | 🔵 **active** | Small (&lt;2h) |
