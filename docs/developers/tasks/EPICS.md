...
**Overall:** 🔵 **active** — ░░░░░░░░░░ 1/21 (5%) across 5 groups — 15 open · 1 active · 4 paused · 1 closed
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 1 | 0 | 1 | █░░░░░░░░░ 14% |
...
graph LR
    ...
    TASK_373["TASK-373"]:::active
    TASK_372["TASK-372"]:::closed
    TASK_147["TASK-147"]:::openExt
    TASK_147 --> TASK_148
    TASK_372 --> TASK_373
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_372
    ...
    click TASK_373 "active/task-373-fix-cpp-comparison-with-wider-type-in-config-loader.md"
...
| ? | [TASK-373](active/task-373-fix-cpp-comparison-with-wider-type-in-config-loader.md) | Fix cpp/comparison-with-wider-type findings in config_loader and config_loader_merge | 🔵 **active** | Small (<2h) |
