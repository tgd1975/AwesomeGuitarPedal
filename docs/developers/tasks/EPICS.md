...
**Overall:** 🔵 **active** — ░░░░░░░░░░ 1/40 (2%) across 11 groups — 31 open · 1 active · 7 paused · 1 closed
...
| [EPIC-027](#epic-027-ble-services-developer-guide) | BLE services developer guide | 🔵 **active** | 2 | 1 | 0 | 1 | ██░░░░░░░░ 25% |
| [EPIC-028](#epic-028-configurable-button-debounce-in-the-hardware-config) | Configurable button debounce in the hardware config | ⚪ _open_ | 2 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
| [—](#unassigned) | _(no epic)_ | ⚪ _open_ | 4 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
graph LR
    ...
    click TASK_366 "active/task-366-draft-catalog-and-recipe-sections.md"
...
| 2 | [TASK-366](active/task-366-draft-catalog-and-recipe-sections.md) | Draft Service catalog + Recipe sections of the BLE services guide (with TASK-354 worked example) | 🔵 **active** | Medium (2-8h) |
...
```mermaid
graph LR
    TASK_375["TASK-375"]:::open
    TASK_376["TASK-376"]:::open
    TASK_375 --> TASK_376
    click TASK_375 "open/task-375-add-debouncems-to-hardware-config-schema-and-model.md"
    click TASK_376 "open/task-376-esp32-button-reads-debouncems-from-hardware-config.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-375](open/task-375-add-debouncems-to-hardware-config-schema-and-model.md) | Add debounceMs to hardware-config schema, example JSON, and Dart model | ⚪ _open_ | Small (&lt;2h) |
| 2 | [TASK-376](open/task-376-esp32-button-reads-debouncems-from-hardware-config.md) | ESP32 — Button reads debounceMs from the loaded hardware config | ⚪ _open_ | Small (&lt;2h) |
...
```mermaid
graph LR
    TASK_377["TASK-377"]:::open
    TASK_378["TASK-378"]:::open
    TASK_379["TASK-379"]:::open
    TASK_380["TASK-380"]:::open
    TASK_381["TASK-381"]:::open
    TASK_382["TASK-382"]:::open
    TASK_377 --> TASK_378
    TASK_377 --> TASK_379
    TASK_378 --> TASK_380
    TASK_379 --> TASK_380
    ...
    TASK_378 --> TASK_382
    TASK_379 --> TASK_382
    click TASK_377 "open/task-377-define-v1-standard-pin-name-set.md"
    click TASK_378 "open/task-378-hardware-config-pinnames-mapping.md"
    click TASK_379 "open/task-379-profile-schema-accept-named-pin-references.md"
    click TASK_380 "open/task-380-esp32-resolve-named-pins-at-config-load.md"
    click TASK_381 "open/task-381-configurator-named-pin-ux-autocomplete-validation-warning.md"
    click TASK_382 "open/task-382-named-pins-builder-docs-and-github-addition-process.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-377](open/task-377-define-v1-standard-pin-name-set.md) | Define the v1 standard pin-name set and pick its canonical home | ⚪ _open_ | Small (&lt;2h) |
| 2 | [TASK-378](open/task-378-hardware-config-pinnames-mapping.md) | Hardware config — pinNames mapping (physical pin → standard name) | ⚪ _open_ | Small (&lt;2h) |
| 3 | [TASK-379](open/task-379-profile-schema-accept-named-pin-references.md) | Profile schema — accept named-pin references alongside direct pin IDs | ⚪ _open_ | Small (&lt;2h) |
| 4 | [TASK-380](open/task-380-esp32-resolve-named-pins-at-config-load.md) | ESP32 firmware — resolve named-pin references at config load | ⚪ _open_ | Medium (2-8h) |
| 5 | [TASK-381](open/task-381-configurator-named-pin-ux-autocomplete-validation-warning.md) | Configurator / app UX — autocomplete, validation, and missing-mapping warning for named pins | ⚪ _open_ | Medium (2-8h) |
| 6 | [TASK-382](open/task-382-named-pins-builder-docs-and-github-addition-process.md) | Named pins — builder docs and GitHub process for proposing additions | ⚪ _open_ | Small (&lt;2h) |
...
graph LR
    ...
    TASK_385 --> TASK_387
    TASK_386 --> TASK_387
    click TASK_383 "open/task-383-wiring-test-tool-env-makefile-scaffolding.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-383](open/task-383-wiring-test-tool-env-makefile-scaffolding.md) | Wiring test tool — PlatformIO env, Makefile target, and compile-time CONFIG flag (ESP32) | ⚪ _open_ | Medium (2-8h) |
