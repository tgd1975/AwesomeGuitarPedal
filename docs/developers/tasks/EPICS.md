...
**Overall:** 🔵 **active** — ██░░░░░░░░ 6/41 (15%) across 11 groups — 28 open · 0 active · 7 paused · 6 closed
...
graph LR
    ...
    click TASK_388 "open/task-388-fix-nodemcu-32s-test-pio-env-so-on-device-button-tests-build.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| ? | [TASK-388](open/task-388-fix-nodemcu-32s-test-pio-env-so-on-device-button-tests-build.md) | Fix nodemcu-32s-test PlatformIO env so on-device button tests build | ⚪ _open_ | Small (&lt;2h) |
