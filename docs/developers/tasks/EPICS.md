...
**Overall:** 🔵 **active** — ░░░░░░░░░░ 0/21 (0%) across 5 groups — 16 open · 1 active · 4 paused · 0 closed
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 6 | 1 | 0 | 0 | ░░░░░░░░░░ 0% |
...
graph LR
    ...
    click TASK_373 "open/task-373-fix-cpp-comparison-with-wider-type-in-config-loader.md"
...
| ? | [TASK-373](open/task-373-fix-cpp-comparison-with-wider-type-in-config-loader.md) | Fix cpp/comparison-with-wider-type findings in config_loader and config_loader_merge | ⚪ _open_ | Small (<2h) |
