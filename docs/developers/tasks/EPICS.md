...
**Overall:** 🔵 **active** — ████░░░░░░ 16/45 (36%) across 11 groups — 21 open · 1 active · 7 paused · 16 closed
...
| [EPIC-029](#epic-029-named-pins--portable-pin-vocabulary-for-shareable-profiles) | Named pins — portable pin vocabulary for shareable profiles | 🔵 **active** | 0 | 1 | 0 | 9 | █████████░ 90% |
...
graph LR
    ...
    TASK_377 --> TASK_392
    TASK_378 --> TASK_392
    click TASK_382 "active/task-382-named-pins-builder-docs-and-github-addition-process.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 6 | [TASK-382](active/task-382-named-pins-builder-docs-and-github-addition-process.md) | Named pins — builder docs and GitHub process for proposing additions | 🔵 **active** | Small (&lt;2h) |
