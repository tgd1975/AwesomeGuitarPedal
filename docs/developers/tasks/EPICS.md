...
**Overall:** 🔵 **active** — █████░░░░░ 21/45 (47%) across 11 groups — 16 open · 1 active · 7 paused · 21 closed
...
| [EPIC-030](#epic-030-interactive-wiringsolder-test-tool) | Interactive wiring/solder test tool | 🔵 **active** | 1 | 1 | 0 | 3 | ██████░░░░ 60% |
...
**Status:** 🔵 **active** — ██████░░░░ 3/5 (60%)

```mermaid
graph LR
    TASK_387["TASK-387"]:::open
    TASK_386["TASK-386"]:::active
    ...
    click TASK_386 "active/task-386-wiring-test-tool-led-individual-mode.md"
...
| 4 | [TASK-386](active/task-386-wiring-test-tool-led-individual-mode.md) | Wiring test tool — LED individual mode (selection, on/off, all-toggle) | 🔵 **active** | Medium (2-8h) |
